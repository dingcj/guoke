...
GK7205V200 GK7202V300 : return 0
GK7205V300             : return 1
...
HI_S32 SAMPLE_COMM_VI_GetMipiLaneMode(HI_VOID)
{
    ...
    if (u32ChipId == CHIP_NAME_GK7205V200 || u32ChipId == CHIP_NAME_GK7205V210 || u32ChipId == CHIP_NAME_GK7202V300)
    {
        SAMPLE_PRT("support this chip %x\n", u32ChipId);
        return 0;
    }
    else if (u32ChipId == CHIP_NAME_GK7205V300 || u32ChipId == CHIP_NAME_GK7605V100)
    {
        SAMPLE_PRT("support this chip %x\n", u32ChipId);
        return 1;
    }
...
HI_S32 SAMPLE_COMM_VI_GetComboAttrBySns(SAMPLE_SNS_TYPE_E enSnsType, combo_dev_t MipiDev, combo_dev_attr_t *pstComboAttr)
{
    switch (enSnsType)
    {
        ...
        case SONY_IMX327_2L_MIPI_2M_30FPS_12BIT:
            ...
            {
                memcpy_s(pstComboAttr, sizeof(combo_dev_attr_t), &MIPI_2lane_CHN0_SENSOR_IMX327_12BIT_2M_NOWDR_ATTR, sizeof(combo_dev_attr_t));
            }
            else if (SAMPLE_COMM_VI_GetMipiLaneMode() == 0)
            {
                memcpy_s(pstComboAttr, sizeof(combo_dev_attr_t), &MIPI_2lane_CHN1_SENSOR_IMX327_12BIT_2M_NOWDR_ATTR, sizeof(combo_dev_attr_t));
            }
        ...
        case SONY_IMX327_2L_MIPI_2M_30FPS_12BIT_WDR2TO1:
            if (SAMPLE_COMM_VI_GetMipiLaneMode() == 1)
            {
                memcpy_s(pstComboAttr, sizeof(combo_dev_attr_t), &MIPI_2lane_CHN0_SENSOR_IMX327_10BIT_2M_WDR2to1_ATTR, sizeof(combo_dev_attr_t));
            }
            else if (SAMPLE_COMM_VI_GetMipiLaneMode() == 0)
            {
                memcpy_s(pstComboAttr, sizeof(combo_dev_attr_t), &MIPI_2lane_CHN1_SENSOR_IMX327_10BIT_2M_WDR2to1_ATTR, sizeof(combo_dev_attr_t));
            }
        ...
        case SMART_SC4236_MIPI_3M_20FPS_10BIT:
            if (SAMPLE_COMM_VI_GetMipiLaneMode() == 1)
            {
                memcpy_s(pstComboAttr, sizeof(combo_dev_attr_t), &MIPI_2lane_CHN0_SENSOR_SC4236_10BIT_3M_NOWDR_ATTR, sizeof(combo_dev_attr_t));
            }
            else if (SAMPLE_COMM_VI_GetMipiLaneMode() == 0)
            {
                memcpy_s(pstComboAttr, sizeof(combo_dev_attr_t), &MIPI_2lane_CHN1_SENSOR_SC4236_10BIT_3M_NOWDR_ATTR, sizeof(combo_dev_attr_t));
            }
            break;
        ...
        case SMART_SC2231_MIPI_2M_30FPS_10BIT:
            if (SAMPLE_COMM_VI_GetMipiLaneMode() == 1)
            {
                memcpy_s(pstComboAttr, sizeof(combo_dev_attr_t), &MIPI_2lane_CHN0_SENSOR_SC2231_10BIT_2M_NOWDR_ATTR, sizeof(combo_dev_attr_t));
            }
            else if (SAMPLE_COMM_VI_GetMipiLaneMode() == 0)
            {
                memcpy_s(pstComboAttr, sizeof(combo_dev_attr_t), &MIPI_2lane_CHN1_SENSOR_SC2231_10BIT_2M_NOWDR_ATTR, sizeof(combo_dev_attr_t));
            }
        ...
        case SOI_JXF37_MIPI_2M_30FPS_10BIT:
            if (SAMPLE_COMM_VI_GetMipiLaneMode() == 1)
            {
                memcpy_s(pstComboAttr, sizeof(combo_dev_attr_t), &MIPI_2lane_CHN0_SENSOR_F37_10BIT_2M_NOWDR_ATTR, sizeof(combo_dev_attr_t));
            }
            else if (SAMPLE_COMM_VI_GetMipiLaneMode() == 0)
            {
                memcpy_s(pstComboAttr, sizeof(combo_dev_attr_t), &MIPI_2lane_CHN1_SENSOR_F37_10BIT_2M_NOWDR_ATTR, sizeof(combo_dev_attr_t));
            }

            break;

        case SMART_SC2235_DC_2M_30FPS_10BIT:
            memcpy_s(pstComboAttr, sizeof(combo_dev_attr_t), &MIPI_CMOS_SENSOR_SC2235_12BIT_2M_NOWDR_ATTR, sizeof(combo_dev_attr_t));
            break;

        case SMART_SC3235_MIPI_3M_30FPS_10BIT:
            if (SAMPLE_COMM_VI_GetMipiLaneMode() == 1)
            {
                memcpy_s(pstComboAttr, sizeof(combo_dev_attr_t), &MIPI_2lane_CHN0_SENSOR_SC3235_10BIT_3M_NOWDR_ATTR, sizeof(combo_dev_attr_t));
            }
            else if (SAMPLE_COMM_VI_GetMipiLaneMode() == 0)
            {
                memcpy_s(pstComboAttr, sizeof(combo_dev_attr_t), &MIPI_2lane_CHN1_SENSOR_SC3235_10BIT_3M_NOWDR_ATTR, sizeof(combo_dev_attr_t));
            }
            break;
        ...
        case OMNIVISION_OS05A_MIPI_5M_30FPS_12BIT: {
            memcpy_s(pstComboAttr, sizeof(combo_dev_attr_t), &MIPI_4lane_CHN0_SENSOR_OS05A_12BIT_5M_NOWDR_ATTR, sizeof(combo_dev_attr_t));
            break;
        }
        ...
        case BT1120_2M_30FPS_8BIT: {
            memcpy_s(pstComboAttr, sizeof(combo_dev_attr_t), &BT1120_2M_30FPS_ATTR, sizeof(combo_dev_attr_t));
            break;
        }
...
HI_S32 SAMPLE_COMM_VI_GetDevAttrBySns(SAMPLE_SNS_TYPE_E enSnsType, VI_DEV_ATTR_S *pstViDevAttr)
{
    switch (enSnsType)
    {
        ...
        case SMART_SC4236_MIPI_3M_30FPS_10BIT:
        case SMART_SC4236_MIPI_3M_20FPS_10BIT:
            memcpy_s(pstViDevAttr, sizeof(VI_DEV_ATTR_S), &DEV_ATTR_SC4236_3M_BASE, sizeof(VI_DEV_ATTR_S));
            pstViDevAttr->au32ComponentMask[0] = 0xFFC00000;
            break;

        case SMART_SC2231_MIPI_2M_30FPS_10BIT:
            memcpy_s(pstViDevAttr, sizeof(VI_DEV_ATTR_S), &DEV_ATTR_SC2231_2M_BASE, sizeof(VI_DEV_ATTR_S));
            break;

        case SOI_JXF37_MIPI_2M_30FPS_10BIT:
            memcpy_s(pstViDevAttr, sizeof(VI_DEV_ATTR_S), &DEV_ATTR_F37_2M_BASE, sizeof(VI_DEV_ATTR_S));
            break;

        case SMART_SC3235_MIPI_3M_30FPS_10BIT:
            memcpy_s(pstViDevAttr, sizeof(VI_DEV_ATTR_S), &DEV_ATTR_SC3235_3M_BASE, sizeof(VI_DEV_ATTR_S));
            pstViDevAttr->au32ComponentMask[0] = 0xFFC00000;
            break;

        case SMART_SC2235_DC_2M_30FPS_10BIT:
            memcpy_s(pstViDevAttr, sizeof(VI_DEV_ATTR_S), &DEV_ATTR_SC2235_2M_BASE, sizeof(VI_DEV_ATTR_S));
            break;
        ...
        case GALAXYCORE_GC2053_MIPI_2M_30FPS_10BIT_FORCAR:
            ...
            break;
        case OMNIVISION_OS05A_MIPI_5M_30FPS_12BIT:
            memcpy_s(pstViDevAttr, sizeof(VI_DEV_ATTR_S), &DEV_ATTR_OS05A_5M_BASE, sizeof(VI_DEV_ATTR_S));
            break;
        case OMNIVISION_OS05A_MIPI_4M_30FPS_12BIT:
        ...
        case OMNIVISION_OS05A_MIPI_4M_30FPS_10BIT_WDR2TO1:
            ...
            break;
        case BT1120_2M_30FPS_8BIT:
            memcpy_s(pstViDevAttr, sizeof(VI_DEV_ATTR_S), &DEV_ATTR_BT1120_BASE, sizeof(VI_DEV_ATTR_S));
            break;
        case BT656_2M_30FPS_8BIT:
            memcpy_s(pstViDevAttr, sizeof(VI_DEV_ATTR_S), &DEV_ATTR_BT656_BASE, sizeof(VI_DEV_ATTR_S));
            break;
        case BT601_2M_30FPS_8BIT:
            memcpy_s(pstViDevAttr, sizeof(VI_DEV_ATTR_S), &DEV_ATTR_BT601_BASE, sizeof(VI_DEV_ATTR_S));
            break;
        default:
            memcpy_s(pstViDevAttr, sizeof(VI_DEV_ATTR_S), &DEV_ATTR_IMX327_2M_BASE, sizeof(VI_DEV_ATTR_S));
    }
...
HI_S32 SAMPLE_COMM_VI_GetPipeAttrBySns(SAMPLE_SNS_TYPE_E enSnsType, VI_PIPE_ATTR_S *pstPipeAttr)
{
    switch (enSnsType)
    {
        ...
        case SONY_IMX335_MIPI_4M_30FPS_12BIT:
            memcpy_s(pstPipeAttr, sizeof(VI_PIPE_ATTR_S), &PIPE_ATTR_2592x1520_RAW12_420_3DNR_RFR, sizeof(VI_PIPE_ATTR_S));
            break;

        case SONY_IMX335_MIPI_4M_30FPS_10BIT_WDR2TO1:
            memcpy_s(pstPipeAttr, sizeof(VI_PIPE_ATTR_S), &PIPE_ATTR_2592x1520_RAW10_420_3DNR_RFR, sizeof(VI_PIPE_ATTR_S));
            break;

        case SMART_SC4236_MIPI_3M_30FPS_10BIT:
        case SMART_SC4236_MIPI_3M_20FPS_10BIT:
            memcpy_s(pstPipeAttr, sizeof(VI_PIPE_ATTR_S), &PIPE_ATTR_2304x1296_RAW10_420_3DNR_RFR, sizeof(VI_PIPE_ATTR_S));
            break;
        ...
        case GALAXYCORE_GC2053_MIPI_2M_30FPS_10BIT_FORCAR:
            ...
            break;
        case OMNIVISION_OS05A_MIPI_5M_30FPS_12BIT:
            memcpy_s(pstPipeAttr, sizeof(VI_PIPE_ATTR_S), &PIPE_ATTR_2688x1944_RAW12_420_3DNR_RFR, sizeof(VI_PIPE_ATTR_S));
            break;
        case OMNIVISION_OS05A_MIPI_4M_30FPS_12BIT:
        ...
        case BT1120_2M_30FPS_8BIT:
        case BT601_2M_30FPS_8BIT:
            memcpy_s(pstPipeAttr, sizeof(VI_PIPE_ATTR_S), &PIPE_ATTR_BT1120_BASE, sizeof(VI_PIPE_ATTR_S));
            break;
        case BT656_2M_30FPS_8BIT:
            memcpy_s(pstPipeAttr, sizeof(VI_PIPE_ATTR_S), &PIPE_ATTR_BT1120_BASE, sizeof(VI_PIPE_ATTR_S));
...
HI_S32 SAMPLE_COMM_VI_GetChnAttrBySns(SAMPLE_SNS_TYPE_E enSnsType, VI_CHN_ATTR_S *pstChnAttr)
{
    switch (enSnsType)
    {
        ...
        case SONY_IMX335_MIPI_4M_30FPS_12BIT:
            memcpy_s(pstChnAttr, sizeof(VI_CHN_ATTR_S), &CHN_ATTR_2592x1520_420_SDR8_LINEAR, sizeof(VI_CHN_ATTR_S));
            break;
        case SONY_IMX335_MIPI_4M_30FPS_10BIT_WDR2TO1:
            memcpy_s(pstChnAttr, sizeof(VI_CHN_ATTR_S), &CHN_ATTR_2592x1520_420_SDR8_LINEAR, sizeof(VI_CHN_ATTR_S));
            break;
        ...
        case SMART_SC4236_MIPI_3M_30FPS_10BIT:
        case SMART_SC4236_MIPI_3M_20FPS_10BIT:
            memcpy_s(pstChnAttr, sizeof(VI_CHN_ATTR_S), &CHN_ATTR_2304x1296_420_SDR8_LINEAR, sizeof(VI_CHN_ATTR_S));
            break;
        ...
        case SMART_SC3235_MIPI_3M_30FPS_10BIT:
            ...
            break;
        case OMNIVISION_OS05A_MIPI_5M_30FPS_12BIT:
            memcpy_s(pstChnAttr, sizeof(VI_CHN_ATTR_S), &CHN_ATTR_2688x1944_420_SDR8_LINEAR, sizeof(VI_CHN_ATTR_S));
            break;
        case OMNIVISION_OS05A_MIPI_4M_30FPS_12BIT:
        case OMNIVISION_OS05A_MIPI_4M_30FPS_10BIT_WDR2TO1:
